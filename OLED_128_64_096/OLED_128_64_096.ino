...
const char TEMP_c[3] = " C";
const char RPM_c[4] = "rpm";
const char MHZ_c[4] = "MHz";
const char GHZ_c[4] = "GHz";
const char PERCENT_c[2] = "%";
...
void draw_dot(int y) {
  u8g2.clearBuffer();  
  u8g2.drawBox(y, 40, 1, 1);
  u8g2.drawBox(y*2, 40, 1, 1);
  u8g2.drawBox(y*3, 40, 1, 1);
  u8g2.sendBuffer();   
}
